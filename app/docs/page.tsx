...
export const metadata: Metadata = createPageMetadata({
  title: "Documentation",
  description:
    "Read the PropertyPro documentation for installation, environment setup, MongoDB, Better Auth migration, maps, the public site module, Cloudflare R2 storage, Stripe, email, deployment, and update workflows.",
  path: "/docs",
  keywords: [
